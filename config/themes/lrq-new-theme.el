...
(let ((class '((class color) (min-colors 89))))
  ...
  (custom-theme-set-faces
   ...
   `(rainbow-delimiters-mismatched-face ((,class (:foreground ,(car bg) :background ,@(cdr red) :weight normal))))
   `(rainbow-delimiters-unmatched-face ((,class (:foreground ,(car bg) :background ,@(cdr red) :weight normal))))
   ...
   `(markdown-code-face   ((,class (:background ,(car blue)))))
   ...
   `(markdown-markup-face             ((,class (:foreground ,(car cyan)))))
   `(markdown-blockquote-face         ((,class (:slant italic :foreground ,(car grey)))))
   `(markdown-pre-face                ((,class (:foreground ,(car teal)))))
   `(markdown-code-face               ((,class (:background ,(car base3) :extend t))))
   `(markdown-reference-face          ((,class (:foreground ,(car grey)))))
   `(markdown-inline-code-face        ((,class (:inherit 'markdown-code-face :extend nil))))
